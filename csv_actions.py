...
# Рекомендуется (и так реализовано) загружать актуальные данные из внешнего файла функцией load_regions_data()
regions_dictionary = {}
...
def fill_listbox_with_regions(listbox: tkinter.Listbox):
    load_regions_data()  # загружаем список регионов из data_files/region_code.csv
    list_items = []
